...
namespace TaskManagementAPI.Migrations
{
    ...
    [Migration("20250404130829_AddTaskAndUserRelationship")]
    partial class AddTaskAndUserRelationship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskManagementAPI.Dutys.Duty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<long?>("AssignedToUserId1")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("TaskManagementAPI.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("TaskManagementAPI.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("TaskManagementAPI.Dutys.Duty", b =>
                {
                    b.HasOne("TaskManagementAPI.Authorization.Users.User", "AssignedToUser")
                        .WithMany()
                        .HasForeignKey("AssignedToUserId1");

                    b.HasOne("TaskManagementAPI.Authorization.Users.User", "CreatedByUser")
                        .WithMany()
