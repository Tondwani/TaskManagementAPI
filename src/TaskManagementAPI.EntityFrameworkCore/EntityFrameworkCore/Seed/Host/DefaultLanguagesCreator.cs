...
public class DefaultLanguagesCreator
{
    ...
    {
        var tenantId = TaskManagementAPIConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(TaskManagementAPIDbContext context)
    {
        _context = context;
    }
