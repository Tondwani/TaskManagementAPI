...
public abstract class TaskManagementAPIWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static TaskManagementAPIWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(TaskManagementAPIWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<TaskManagementAPIDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<TaskManagementAPIDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<TaskManagementAPIDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<TaskManagementAPIDbContext, Task<T>> func)
    {
        T result;
